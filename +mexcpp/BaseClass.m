...
%   C++ class shall inherit mexFunctionClass derived in include/mexClassHandler.h.
...
%
%   The header file 'include/mexClassHandler.h' defines 3 key elements to interact
%   with this Matlab class: mexClassHandle, mexClassHandler, and mexFunctionClass.
%
%   The mexClassHandle is based on Oliver Woodford's class wrapper
...
%
%   The mexClassHandler template function requires to be specified for the user's
